...
ROWS = [
    ("host",),
    ("kv", "Now", "AI Engineer @ Orizon Technology"),
    ("kv", "Prev", "AI Software Developer @ Algorise Ltd"),
    ("kv", "Also", "AI Software Engineer @ Turing"),
    ("kv", "Edu", "BSc Software Eng, Addis Ababa Univ '25"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, Nuxt, Vue, Tailwind"),
    ("kv", "Backend", "FastAPI, Node, NestJS, Django"),
    ("kv", "AI / ML", "LangGraph, LangChain, CrewAI, RAG"),
    ("kv", "Data", "PostgreSQL, MongoDB, pgvector"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built multi-agent EdTech tutoring platform"),
    ("bul", "30+ AI workflows · 99.9% API uptime"),
]
...
parts.append(f'<text x="{W/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
             f'text-anchor="middle">yohannesjoya@github: ~$ neofetch</text>')
